...
$lang['marketplace_getting_started'] = 'Getting Started';
$lang['marketplace_wizard_congrats'] = 'Congratulations!  You are now ready to install apps and integrated cloud services through the ClearCenter Marketplace.  You will find a large selection of both free and paid apps that can be installed in just a few short steps.';
$lang['marketplace_install_by_function'] = 'Install by Function';
$lang['marketplace_install_by_function_description'] = 'If you are new to ClearOS or prefer to configure the system by specific tasks (eg. prevent users from accssing certain websites, share files between users etc.), select this option.';
$lang['marketplace_install_by_category'] = 'Install by Category';
