...
$lang['marketplace_app_deleted'] = 'The following app has been deleted';
...
$lang['marketplace_app_review_description'] = 'Almost done!  Please review the summary below.  If you have changed your mind, please free to delete apps or go back to select new ones.  Do not forget that you can always install apps later via the ClearOS Marketplace.';
...
$lang['marketplace_apps_minimum_hardware_requirements'] = 'The app %s requires a minimum %s of %s - this system has only %s.';
$lang['marketplace_apps_per_page'] = 'Number of Apps to Display';
$lang['marketplace_apps_requires_vt'] = 'The app %s requires a CPU with Virtualization Technology. Check your BIOS settings or upgrade your system.';
...
$lang['marketplace_gateway_apps_description'] = 'Gateway Apps provide powerful tools to manage what leaves and enters your network.  You do not have to be running in gateway mode to take advantage of these apps.  The Content Filter, Gateway Antivirus, Intrusion Protection and other apps can be enabled on a standalone server.';
...
$lang['marketplace_install_by_function_description'] = 'If you are new to ClearOS or prefer to configure the system by specific tasks (for example, prevent users from accessing certain websites, share files between users etc.), select this option.';
...
$lang['marketplace_mode_category_best_practices_help'] = 'Security experts will agree providing separation (physical or virtual) between services providing perimeter security from those that provide userland infrastructure (mail, file, print servers etc.) is always recommended.  For small environments or those where economics play a dominant role, ClearOS can be used to provide as few or as many services across the full Network, Gateway and Server spectrum.';
...
$lang['marketplace_mode_qsf_best_practices_help'] = 'ClearOS Marketplace Quick Select Files are freely available from the ClearOS website.';
...
$lang['marketplace_support_8_description'] = 'ClearCenter will provide professional support under the conditions appropriate for the paid support subscription this system is subscribed to.  All new support incidents must be initiated via the ClearCARE support incident system.';
